    ...
    sortedPeriodDates() {
      ...
      if (this.periodDates) {
        const combinedSortFunction = (fecha1, fecha2) => {
          ...
          const v1U = new Date(fecha1.updatedAt)
          const v2U = new Date(fecha2.updatedAt)

          return v1U - v2U // More recent updatedAt comes first
        }

        periodDates = [...this.periodDates].sort(combinedSortFunction)
      }
